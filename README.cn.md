...
[![x-cmd/install — nushell Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/nushell.svg?lang=zh)](https://x-cmd.com/install/nushell)
...
合计: **383,144** 行代码（覆盖前 5 种语言、共 **2093** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Rust | 378,711 | 11,677 | 45,128 | 1945 |
| Toml | 2,275 | 110 | 332 | 57 |
| Json | 624 | 0 | 4 | 53 |
| Yaml | 589 | 40 | 47 | 36 |
| Nix | 294 | 20 | 7 | 2 |
...
- **上游仓库**: <https://github.com/nushell/nushell>
...
- **Star**: 40,554 · **Fork**: 2,269 · **开放 issue**: 7,334 · **贡献者**: 872

## 累计统计

- **发布数**: 125 · **已合并 PR**: 9227 · **开放 PR**: 58 · **已关闭 issue**: 5946 · **开放 issue**: 1388 · **提交数**: 11891

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-24 | 0 | 80 | 35 | 14 | 28 | 105 |
| last60d | 2026-07-25 | 2 | 173 | 43 | 39 | 44 | 186 |
| 90d | 2026-06-25 | 4 | 325 | 48 | 77 | 61 | 349 |
| last180d | 2026-03-27 | 8 | 638 | 57 | 172 | 107 | 685 |
| 360d | 2025-09-28 | 13 | 1196 | 58 | 391 | 234 | 1303 |
| last720d | 2024-10-03 | 26 | 2442 | 58 | 1051 | 567 | 2492 |
...
nushell 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `nushell` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/nushell.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T06:13:11Z._
